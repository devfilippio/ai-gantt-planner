...
|---|---|---|
| `OPENROUTER_API_KEY` | для настоящего чата | ключ OpenRouter для LLM-агента (`openai/gpt-4o-mini`, при ошибке — эскалация на `anthropic/claude-sonnet-4.5`) |
