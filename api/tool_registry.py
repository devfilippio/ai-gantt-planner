...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            "name": "shift_tasks",
            "description": "Сдвигает начало задач на N дней (длительность не меняется); отрицательное N — раньше. "
                            "Если assignee не указан — сдвигается ВЕСЬ план («передвинь все задачи на 3 дня»).",
            "parameters": {
                "type": "object",
                "properties": {
                    "assignee": {"type": "string", "description": "Ответственный, чьи задачи сдвинуть. Не указывай, чтобы сдвинуть все задачи плана."},
                    "days": {
                        "type": "integer",
